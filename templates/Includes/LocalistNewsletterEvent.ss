...
<% loop $Dates.First %><% include LocalistDateLongNoLinks %><% end_loop %><% if $Dates.Count > "1" %><a href="{$AfterClassLink}" target="_blank">more dates</a><% end_if %><br>
<% include LocalistLocationLongNoLinks %><br>Cost: $Cost
        </td>
    </tr>
</tbody></table>
